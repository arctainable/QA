...
<meta name="google-site-verification" content="8r9UGBGY_lm54UU9rhtI13Y1MxDEwoe-xA6svDGaH9c">
<title>회원가입약관</title>
<link rel="stylesheet" href="./css/회원가입약관_files/style.min.css">
...
<div class="mb_fwrap">
	<div class="mb_wrap">
		...
		<div class="mb_sign mb_mid">
			<h1 class="mb_tit">회원가입 약관</h1>
			<form name="fregister" id="fregister" action="member2.do" onsubmit="return fregister_submit(this);" method="POST" autocomplete="off" class="frm">
			<div id="fregister_chkall" class="item tr">
				<input type="checkbox" name="chk_all" value="1" id="chk_all" class="urm-chk">
				<label for="chk_all">전체선택</label>
			</div>
			<div id="fregister_term" class="item">
				<strong class="g_label">회원가입약관</strong>
				<textarea readonly="" class="g_text" rows="7">제 1 장 총칙

제 1 조 (목적)
본 약관은  이 운영하는 웹 사이트-의 제반 서비스의 이용조건 및 절차에 관한 사항 및 기타 필요한 사항을 규정함을 목적으로 한다.
...
&lt;부칙&gt;
본 약관은 2018년 12월 23일부터 적용한다.
</textarea>
				<div class="item_hf">
					<input type="checkbox" name="agree" value="1" id="agree11" class="urm-chk">
					<label for="agree11">회원가입약관의 내용에 동의합니다.</label>
				</div>
			</div>

			<div id="fregister_private" class="item tr">
				<strong class="g_label">개인정보처리방침안내</strong>
				<textarea readonly="" class="g_text" rows="7">개인정보 수집/이용에 대한 동의서

아래는 저희   가입에 따른 개인정보 수집/이용에 따른 동의서입니다. 

저희  에서는 제 3자에 대해 정보제공을 하지 않고 있습니다.
...
&lt;개인정보의 보유 및 이용 기간&gt;
 ...
 에서 가입 시 부터 탈퇴 시 까지, 탈퇴 시 지체없이 개인정보 파기
 

&lt;동의를 거부할 권리가 있다는 사실 및 동의 거부에 따른 불이익이 있는 경우에는 그 불이익의 내용&gt;

미동의 시 개인정보확인불가능으로 서비스가입 불가능</textarea>
				<div class="item_hf">
					<input type="checkbox" name="agree2" value="1" id="agree21" class="urm-chk">
					<label for="agree21">개인정보처리방침안내의 내용에 동의합니다.</label>
				</div>
			</div>

			<div class="item">
				<button type="submit" class="btn btn_blue btn_fx">약관동의</button>
			</div>
		</form>
		</div>
	</div>
...
<![endif]-->
<script type="text/javascript" async="" src="./회원가입약관_files/analytics.js.다운로드"></script><script async="" src="./회원가입약관_files/js"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-134412556-1');
</script>
<script>
...
<script async="" src="./회원가입약관_files/f.txt"></script>
<script type="text/javascript" src="./회원가입약관_files/jquery.min.js.다운로드"></script>
<script type="text/javascript" src="./회원가입약관_files/cu.js.다운로드"></script>
<script type="text/javascript" src="./회원가입약관_files/register.js.다운로드"></script>
